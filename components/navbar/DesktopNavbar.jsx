...
const DesktopNavbar = ({ children }) => {
  ...
  return (
    <>
      <div className='border-b w-full flex justify-between items-center px-3 py-[0.30rem] xl:px-96'>

        <div id='instagram__logo' className='inline-flex justify-center items-center py-1.5'>
          <Image src={instagramLogo} alt="instagram logo" width="104" height="37"/>
        </div>

        <div id="search_bar" className='justify-center items-center relative ml-32 hidden lg:inline-flex'>

          <input type="text" className='bg-[#EFEFEF] py-1.5 px-12 rounded-md font-thin' placeholder="Search"/>
          <svg className='absolute top-2.5 left-4' aria-label="Search" color="#8e8e8e" fill="#8e8e8e" height="16" role="img" viewBox="0 0 24 24" width="16"><path d="M19 10.5A8.5 8.5 0 1110.5 2a8.5 8.5 0 018.5 8.5z" fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2"></path><line fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" x1="16.511" x2="22" y1="16.511" y2="22"></line></svg>
        
        </div>

        <div id="icons" className='inline-flex justify-center items-center space-x-5'>
          ...
          <button id="profile" className=''>
            <div className='w-[24px]  mt-[0.35rem]'>
